...
class EmailsController extends Ve_Controller_Base {
    ...
    public function listAction() {
		...
		$paginator=$pageObj->fetchPageDataResult($emailData,$page,5);
	...
	public function updateemailAction(){
		...
		if(isset($data)){
			...
			try{
			   ...
			   $updateData['role'] = $data['user_role'];
	...
	public function consoleAction(){
		...
		$build_ID = $_COOKIE['build_cookie'];
		 ...
		 $set_cookie = setcookie('build_cookie',$build_ID);
		if($companyListing!=''){
			if($build_ID!='')
