			...
			return false; 
				...
				$.ajax({
						...
						data        : {
							            ...
							            set_default:set_default,assign_to:account_user
							          },
						success     : function( data ) {
							$('.loader').hide(); 
							var content = $.parseJSON(data);
...
function deleteLaborCharge(blid){
	...
	var return_value = prompt("For Deleting Labor Charge, Enter Yes in Capital letter.");
	    if(return_value!=null){	
				...
				$('#bill_error').html('You have entered wrong word.');
			}
		}
}
...
function deleteRateCharge(brid){
	var check_delete='YES';	
	var return_value = prompt("For Deleting Rate Charge, Enter Yes in Capital letter.");
	    if(return_value!=null){	
				if(check_delete === return_value){				
				$('.loader').show();
				$.ajax({        
         ...
         if(submit_flag==false){			 
			...
			return false; 
				...
				$.ajax({
						...
						data        : {
							            rate_name:rate_name,description:description,status:status,
							            multiplier:multiplier,set_default:set_default,brid:brid,building:bId,
							          },
						success     : function( data ) {
							$('.loader').hide(); 
							var content = $.parseJSON(data);
