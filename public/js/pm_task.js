...
function validateTypeDesination() {
    $('.loader').show();
    var isValid = true;
    var desig_id = $("#desig_id").val();
    var temptypedata = $("input[name='temptypedata']:checked").val();
    if (temptypedata == 1) {
        var tempname = $("#tempname").val();
        var typedesignation = $("#typedesignation").val();
        if (typedesignation == '') {
            $("#typedesignation").focus();
            $("#typedesignation").addClass('error-border');
            $("#typedesignation_error").html("Please fill the field");
            isValid = false;
        } else {
            typedesignation = typedesignation + ' - User Created Template';
            $("#typedesignation_error").html("");
            $("#typedesignation").removeClass('error-border');
        }
        if (isValid === false) {
            $('.loader').hide();
            return false;
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + 'pm/validatevttemplatename',
                data: {vttempname: tempname, typedesignation: typedesignation},
                success: function (msg) {
                    //console.log(msg);
                    $('.loader').hide();
                    if (msg.trim() == 'false') {
                        ...
                        $('#typedesignation').focus();
                        $("#typedesignation").addClass('error-border');
                        $("#typedesignation_error").html("Type Designation has already been assigned.");
                        return false;
                    } else {
                        var VT_Template_Name_ID = msg.trim();
                        $('.confirm').prop('disabled', true);
                        $.ajax({
                            type: "POST",
                            url: baseUrl + 'pm/savevttypedesignation',
                            data: {typedesignation: typedesignation, VT_Template_Name_ID: VT_Template_Name_ID, desig_id:desig_id},
                            success: function (data) {
                               // console.log(data);
                                if (data.trim() == 'true') {
    ...
    if (temptypedata == 2) {
        var tempname = $("#existingtempname").val();
        var typedesignation = $("#typedesignation").val();
        if (typedesignation == '') {
            $("#typedesignation").focus();
            $("#typedesignation").addClass('error-border');
        ...
        if (tempname == '') {
            $("#existingtempname").focus();
            $("#existingtempname").addClass('error-border');
            $("#existingtempname_error").html("Please select");
            isValid = false;
        } else {
            $("#existingtempname_error").html("");
            $("#existingtempname").removeClass('error-border');
        }
    ...
    if (temptypedata == 3) {
        var tempname = $("#temptypedatanew").val();
        var typedesignation = $("#typedesignation").val();
        if (typedesignation == '') {
            $("#typedesignation").focus();
            $("#typedesignation").addClass('error-border');
        ...
        if (tempname == '') {
            $("#temptypedatanew").focus();
            $("#temptypedatanew").addClass('error-border');
            $("#temptypedatanew_error").html("Please Enter Template Name");
            
            isValid = false;
        } else {
            $("#temptypedatanew_error").html("");
            $("#temptypedatanew").removeClass('error-border');
        }
        ...
        if (isValid === false) {
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + 'pm/validatevttemplatename',
                data: {vttempname: tempname, typedesignation: typedesignation, temptypedata: temptypedata},
                success: function (msg) {
                    //console.log(msg);
                    $('.loader').hide();
                    if (msg.trim() == false) {
                        $('#temptypedatanew').focus();
                        $("#temptypedatanew").addClass('error-border');
                        $("#temptypedatanew_error").html("Template Name has already been assigned.");
                        return false;
                    } else if (msg.trim() == 'No') {
                        $('#typedesignation').focus();
                        $("#typedesignation").addClass('error-border');
                        ...
                        $.ajax({
                            type: "POST",
                            url: baseUrl + 'pm/savevttypedesignation',
                            data: {typedesignation: typedesignation, vttempname: tempname, temptypedata: temptypedata, desig_id:desig_id},
                            success: function (data) {
                                if (data.trim() == 'true') {
                                    $("#success").html('Data has been saved!');
                                    parent.jQuery.fancybox.close();
