<?php
	...
	$report_key = sti_get_parameter_value("Vision_report_key");
	...
	function sti_send_email_report($format, $report_key, $email, $subject, $message, $file_name, $data)
	{
		...
		$_options = array(
			...
			"from" => "no-replay@visionworkorders.com",
			// Name and surname of the sender
			"name" => "Vision Work Order Report",
			...
			"host" => "mail.visionworkorders.com",
			// Port of the SMTP server
			"port" => 25,
			// The secure connection prefix - ssl or tls
			"secure" => "",
			// Login (Username or Email)
			"login" => "no-reply@visionworkorders.com",
			// Password
			"password" => "Welcome1!"
		);
