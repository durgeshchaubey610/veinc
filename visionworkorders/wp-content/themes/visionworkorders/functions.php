...
// Set UI labels for Custom Post Type
	$labels = array(
		...
		'testimonial_items'        => __( 'Search Testimonial', 'twentythirteen' ),
		'not_found'           => __( 'Not Found', 'twentythirteen' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'twentythirteen' ),
	);
...
function theme_slug_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Footer section', 'theme-slug' ),
        'id' => 'sidebar-5',
...
add_action( 'widgets_init', 'theme_top_header_init' );
function theme_top_header_init() {
    register_sidebar( array(
        'name' => __( 'Top header bar', 'theme-slug' ),
        'id' => 'sidebar-6',
        'description' => __( 'Widgets in this area will be shown on all posts and pages.', 'theme-slug' ),
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
	'after_widget'  => '</li>',
...
class wpb_widget extends WP_Widget {
    ...
    function __construct() {
            ...
            __('Top bar option', 'wpb_widget_domain'), 
    ...
    public function widget( $args, $instance ) {
        ...
        echo '<ul>';        
        if($phone!="")
            echo '<li>Phone : <a href="tel:">'. $phone .'</a></li>';        
        if($email!="")    
...
function wpb_load_widget() {
	register_widget( 'wpb_widget' );
        register_widget( 'wpb_widget_footer' );
        register_widget( 'wpb_subcriber_footer' );
}
add_action( 'widgets_init', 'wpb_load_widget' );


// Creating the widget 
class wpb_widget_footer extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo '<ul>';        
        if($phone!="")
            echo '<li>Phone : <a href="">'.$args['before_phone'] . $phone . $args['after_phone'].'</a></li>';        
        if($email!="")    
        echo '<li>Email : <a href="emailto:'.$args['before_email'] . $email . $args['after_email'].'">'.$args['before_email'] . $email . $args['after_email'].'</a></li>';        
        echo '</ul>';
    }		
    // Widget Backend 
    public function form( $instance ) {
...
// Creating the widget 
class wpb_subcriber_footer extends WP_Widget {

    function __construct() {
            parent::__construct(
            // Base ID of your widget
            'wpb_subcriber_footer', 

            // Widget name will appear in UI
            __('Footer Subcriber', 'wpb_widget_domain'), 
    ...
    // This is where the action happens
    public function widget( $args, $instance ) {
         echo '<div class="col-md-6 col-sm-9 vt_subscribe_newsletter">
            <h3>Subscribe to our newsletter</h3>';
            echo do_shortcode('[mc4wp_form id="60"]');
          echo '</div>';
    }		
