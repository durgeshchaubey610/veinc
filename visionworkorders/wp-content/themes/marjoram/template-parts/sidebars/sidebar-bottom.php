	...
	<aside class="widget-area container">
			...
			<div class="row">		   
				<?php if ( is_active_sidebar( 'bottom1' ) ) : ?>
					<div id="bottom1" <?php marjoram_bottom_group(); ?>>
						<?php dynamic_sidebar( 'bottom1' ); ?>
					</div>
				<?php endif; ?>
				
				<?php if ( is_active_sidebar( 'bottom2' ) ) : ?>      
					<div id="bottom2" <?php marjoram_bottom_group(); ?>>
						<?php dynamic_sidebar( 'bottom2' ); ?>
					</div>         
				<?php endif; ?>
				
				<?php if ( is_active_sidebar( 'bottom3' ) ) : ?>        
					<div id="bottom3" <?php marjoram_bottom_group(); ?>>
						<?php dynamic_sidebar( 'bottom3' ); ?>
					</div>
				<?php endif; ?>
				
				<?php if ( is_active_sidebar( 'bottom4' ) ) : ?>        
					<div id="bottom4" <?php marjoram_bottom_group(); ?>>
