    ...
    function getLabor($woid) {
        ...
        if ($cnt > 0) {
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (($evenodd % 2)) {
                    $evenodd++;
                    $html .= "<tr style='background:#f9f9f9 ;'><td>" . $evenodd . "</td><td>" . $row['firstName'] . " " . $row['lastName'] . "</td><td>$" . $row['charge_hour'] . "</td><td>" . $row['description'] . "</td><td>" . $row['job_time'] . "<div class='select_action'>
								<ul>
                    ...
                    $evenodd++;
                    $html .= "<tr style='background:#f1f1f1 ;'><td>" . $evenodd . "</td><td>" . $row['firstName'] . " " . $row['lastName'] . "</td><td>$" . $row['charge_hour'] . "</td><td>" . $row['description'] . "</td><td>" . $row['job_time'] . "<div class='select_action'>
								<ul>
								   <li><a onclick=\"updateLabourDataTemp('" . $row['emp_id'] . "', '" . $row['charge_hour'] . "', '" . $rate_charge . "', '" . $row['brid'] . "','" . $row['job_time'] . "', '" . $row['woId'] . "', '" . $row['lid'] . "')\">Edit</a></li>
								  <li><a onclick=\"deleteLabourTemp('" . $row['woId'] . "','" . $row['lid'] . "')\">Delete</a></li>
								  <li><a class=\"closeActionPopUp\">Close</a></li>
    ...
    function getBuildingServices($woid) {
        ...
        if ($cnt > 0) {
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (($evenodd % 2)) {
                    $evenodd++;
                    $html .= "<tr style='background:#f9f9f9 ;'><td>" . $evenodd . "</td><td>" . $row['service_name'] . "</td><td>$" . $row['charge'] . "</td><td>" . $row['unit_measure'] . "</td><td>" . $row['amount_requested'] . "</td><td>" . $row['comment'] . "	<div class='select_action'>
								<ul>
                    ...
                    $evenodd++;
                    $html .= "<tr style='background:#f1f1f1 ;'><td>" . $evenodd . "</td><td>" . $row['service_name'] . "</td><td>$" . $row['charge'] . "</td><td>" . $row['unit_measure'] . "</td><td>" . $row['amount_requested'] . "</td><td>" . $row['comment'] . "<div class='select_action'>
								<ul>
								  <li><a onclick=\"updateBServiceDataTemp('" . $row['bsId'] . "', '" . $row['service'] . "', '" . $row['charge'] . "', '" . $row['amount_requested'] . "', '" . $row['comment'] . "', '" . $row['woId'] . "', '" . str_replace("'", ";-", $row['service_name']) . "', '" . $row['building'] . "')\">Edit</a></li>
								  <li><a onclick=\"deleteBserviceTemp('" . $row['bsId'] . "')\">Delete</a></li>
								  <li><a class=\"closeActionPopUp\">Close</a></li>
    ...
    function getMaterials($woid) {
        ...
        if ($cnt > 0) {
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (($evenodd % 2)) {
                    $evenodd++;
                    $html .= "<tr style='background:#f9f9f9 ;'><td>" . $evenodd . "</td><td>" . $row['description'] . "</td><td>$" . $row['cost'] . "</td><td>" . $row['quantity'] . "</td><td>" . $row['markup'] . "</td><td>" . $tax . "<div class='select_action'>
							<ul>
                    ...
                    $evenodd++;
                    $html .= "<tr style='background:#f1f1f1 ;'><td>" . $evenodd . "</td><td>" . $row['description'] . "</td><td>$" . $row['cost'] . "</td><td>" . $row['quantity'] . "</td><td>" . $row['markup'] . "</td><td>" . $tax . "<div class='select_action'>
						<ul>
						   <li><a onclick=\"updateMaterialsDataTemp('" . $row['cost'] . "', '" . $row['quantity'] . "', '" . $val_tax . "', '" . $row['markup'] . "','" . $row['mid'] . "', '" . $row['woId'] . "', '" . $row['mcId'] . "')\">Edit</a></li>
						  <li><a onclick=\"deleteMaterialTemp('" . $row['woId'] . "','" . $row['mcId'] . "')\">Delete</a></li>
						  <li><a class=\"closeActionPopUp\">Close</a></li>
    ...
    function getOutsideServices($woid) {
        ...
        if ($cnt > 0) {
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (($evenodd % 2)) {
                    $evenodd++;
                    $html .= "<tr style='background:#f9f9f9 ;'><td>" . $evenodd . "</td><td>" . $row['company_name'] . "</td><td>" . $row['job_description'] . "</td><td>$" . $row['job_cost'] . "</td><td>" . $row['markup'] . "</td><td>" . $tax . "<div class='select_action'>
							<ul>
                    ...
                    $evenodd++;
                    $html .= "<tr style='background:#f1f1f1 ;'><td>" . $evenodd . "</td><td>" . $row['company_name'] . "</td><td>" . $row['job_description'] . "</td><td>$" . $row['job_cost'] . "</td><td>" . $row['markup'] . "</td><td>" . $tax . "<div class='select_action'>
							<ul>
							   <li><a onclick=\"updateOutsideServiceDataTemp('" . $row['vid'] . "', '" . $row['job_description'] . "', '" . $row['job_cost'] . "', '" . $row['markup'] . "','" . $tax . "', '" . $row['woId'] . "', '" . $row['osId'] . "')\">Edit</a></li>
							  <li><a onclick=\"deleteOutsideTemp('" . $row['woId'] . "','" . $row['osId'] . "')\">Delete</a></li>
							  <li><a class=\"closeActionPopUp\">Close</a></li>
    ...
    function getNotes($woid) {
        ...
        if ($cnt > 0) {
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (($evenodd % 2)) {
                    $evenodd++;
                    $html .= "<tr style='background:#f9f9f9 ;'><td>" . $evenodd . "</td><td>" . $date . "</td><td>" . $row['note'] . "</td><td>" . $internal . "<div class='select_action'>
												<ul>
                    ...
                    $evenodd++;
					$html .= "<tr style='background:#f1f1f1 ;'><td>" . $evenodd . "</td><td>" . $date . "</td><td>" . $row['note'] . "</td><td>" . $internal . "<div class='select_action'>
						<ul>
						   <li><a onclick=\"updateNotesDataTemp('" . $date . "', '" . $row['note'] . "', '" . $internal . "', '" . $row['woId'] . "', '" . $row['wnId'] . "')\">Edit</a></li>
						  <li><a onclick=\"deleteNoteTemp('" . $row['wnId'] . "')\">Delete</a></li>
						  <li><a class=\"closeActionPopUp\">Close</a></li>
